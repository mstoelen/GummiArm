...
class Teleop:
    ...
    def __init__(self):
        pi = 3.1416
        self.elbow = Antagonist(1, -1, "biceps", "triceps", "elbow_encoder", 0, 2*pi, -0.75, 0.85)
        self.wrist = Antagonist(-1, -1, "wrist_flexor", "wrist_extensor", "wrist_encoder", 0, 1.75*pi, -1.0, 1.0)
        self.shoulderPitch = Antagonist(-1, -1, "shoulder_abductor", "shoulder_adductor", "shoulder_pitch_encoder", 0, 2*pi, -1.0, 1.0)
        self.shoulderRoll = DirectDrive("shoulder_roll", 1.75*pi)
    ...
    def cmdCallback(self, msg):
        ...
        self.shoulderRollVel = - msg.angular.z * velGain
    ...
    def doUpdate(self):
        ...
        self.shoulderRoll.servoWith(self.shoulderRollVel)
