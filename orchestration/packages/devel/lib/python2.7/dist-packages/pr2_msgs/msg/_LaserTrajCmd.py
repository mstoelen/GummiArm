...
"""autogenerated by genpy from pr2_msgs/LaserTrajCmd.msg. Do not edit."""
import sys
...
class LaserTrajCmd(genpy.Message):
  _md5sum = "68a1665e9079049dce55a0384cb2e9b5"
  _type = "pr2_msgs/LaserTrajCmd"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# This message is used to set the profile that the tilt laser controller
# executes.
Header header
...
string frame_id
"""
  __slots__ = ['header','profile','position','time_from_start','max_velocity','max_acceleration']
  _slot_types = ['std_msgs/Header','string','float64[]','duration[]','float64','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,profile,position,time_from_start,max_velocity,max_acceleration
    ...
    """
    if args or kwds:
      super(LaserTrajCmd, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.time_from_start)
      buff.write(_struct_I.pack(length))
      for val1 in self.time_from_start:
        _x = val1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.profile = str[start:end].decode('utf-8')
      else:
      ...
      for i in range(0, length):
        ...
        self.time_from_start.append(val1)
      _x = self
      start = end
      end += 16
