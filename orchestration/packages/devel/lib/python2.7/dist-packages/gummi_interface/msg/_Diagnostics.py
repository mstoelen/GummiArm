...
float64 forward_error"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_7d.pack(_x.equilibrium, _x.cocontraction, _x.ballistic, _x.encoder, _x.alpha_flexor, _x.alpha_extensor, _x.forward_error))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.equilibrium, _x.cocontraction, _x.ballistic, _x.encoder, _x.alpha_flexor, _x.alpha_extensor, _x.forward_error,) = _struct_7d.unpack(str[start:end])
      return self
