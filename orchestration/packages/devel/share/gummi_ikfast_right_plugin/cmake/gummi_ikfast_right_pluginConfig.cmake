...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gummi_ikfast_right_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gummi/GummiArm/orchestration/packages/src/gummi_ikfast_right_plugin/${idir}'.  Ask the maintainer 'mstoelen <mstoelen@todo.todo>' to fix it.")
    endif()
