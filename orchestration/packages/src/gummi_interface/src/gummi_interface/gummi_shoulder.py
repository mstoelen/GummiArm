...
class GummiShoulder:
    ...
    def initJoints(self):
        self.shoulderYaw = Antagonist("shoulder_yaw", True)
        self.shoulderRoll = Antagonist("shoulder_roll", False)
        self.shoulderPitch = Antagonist("shoulder_pitch", False)
        self.upperarmRoll = DirectDrive("upperarm_roll", self.pi)
        self.elbow = Antagonist("elbow", True)
        self.forearmRoll = DirectDrive("forearm_roll", 1.75*self.pi)
        self.wrist = Antagonist("wrist", True)
    ...
    def goRestingPose(self, now):
        ...
        self.shoulderPitch.goTo(0.1, self.shoulderPitchCocont, now)
