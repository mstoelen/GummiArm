...
echo_and_run cd "/home/gummi/GummiArm/orchestration/packages/src/gummi_interface"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/gummi/GummiArm/orchestration/packages/build/gummi_interface" \
    install \
    $DESTDIR_ARG \
